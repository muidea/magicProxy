...
func (s *backStmt) ParamNum() int {
	return s.params
}

func (s *backStmt) ColumnNum() int {
	return s.columns
}
...
func (s *backStmt) Execute(args ...interface{}) (*mysql.Result, error) {
...
func (s *backStmt) write(args ...interface{}) error {
	paramsNum := s.params
...
func (c *backConn) Prepare(query string) (*backStmt, error) {
