// Copyright 2016 The sql-endpoint Authors. All rights reserved.
//
...
func TestCalcPassword(t *testing.T) {
	...
	*/
	...
	t.Logf("rnd seed: %s, %s", sqltypes.Strings(test), hex_test)

	seed := sqltypes.Slice("@jx=d_3z42;sS$YrS)p|")
	...
	scramble := CalcPassword(seed, sqltypes.Slice("kingshard"))
